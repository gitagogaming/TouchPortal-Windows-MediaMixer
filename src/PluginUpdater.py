...
if __name__ == "__main__":
    ...
    updater = GitHubUpdater(owner='gitagogaming', repo='TouchPortal-Windows-MediaMixer', icon_path=r"C:\Users\GitPC\Documents\GitHub\TouchPortal-Windows-MediaMixer\src\icon.png", TPClient=None, pre_releases=False)
